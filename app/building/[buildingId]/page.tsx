...
import { getWalkScore, getGrokData } from "@/lib/api";
...
export default async function BuildingPage({
  ...
  let grokData;
  try {
    grokData = await getGrokData(lat, lon);
    console.log("Grok data fetched successfully:", grokData);
  } catch (error) {
